...
```{python id="cdac0de1", outputId="90cb2483-4e13-40c0-f3b2-085d91a09030", colab={'base_uri': 'https://localhost:8080/', 'height': 142}}
high_demand_df[4]
```
...
```{python id="dbc49f6d", outputId="f6888a03-2d0f-4fd4-f20b-439fbfd1e961", colab={'base_uri': 'https://localhost:8080/', 'height': 1000}}
for interval in range(1, 9):
